...
from bim.adapters.shapely_to_cq import shapely_a_cadquery
...
def cuadrante_1(vertices_terreno, df_excel):
    ...
    factory_capas.add_in_capa_auto(workplane=piso_solido, nivel=1, name="Cuadrante")
    ...
    return cuadrante_max_and_terreno, ensamblaje, factory_capas
