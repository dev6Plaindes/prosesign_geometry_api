# [DOCUMENTACIÓN] Se agregó min_floors para definir el número de pisos inicial de acuerdo a la Tarea 5&6.
def encontrar_configuracion_ideal(data, largo_max_terreno=80.0, min_floors=1):
