...
def generate_techo(
    ...
    """
    # [DOCUMENTACIÓN] Se omitirá la generación de la losa plana si la zona climática es z1 o z3,
    # ya que en esos casos create_structure ya genera los techos especiales correspondientes.
    if CONFIG_PROYECTO.get("zona_climatica") in ["z1", "z3"]:
        return
